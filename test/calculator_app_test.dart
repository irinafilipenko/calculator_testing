...
import 'package:calculator_unit_test/main.dart';
...
void main() {
  ...
  group('Operation Widget', () {
    ...
    testWidgets('render ' ' when 3 and 0 added', (tester) async {
      when(() => calculator.divide(3, 0))
          .thenThrow(Exception('Cannot divide by zero'));

      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: OperationWidget(
              operation: Operation.divide, calculator: calculator),
        ),
      ));
