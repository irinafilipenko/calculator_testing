...
import 'package:calculator_unit_test/main.dart' as app;

void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  group('app test', () {
    testWidgets('adding 20 and 58.2 and gets number from the service',
        (tester) async {
      ...
      final elevatedButtonFinder =
          find.byKey(const Key('elevated_button_Adding'));
